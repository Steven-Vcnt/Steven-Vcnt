...
For this guide, you will need to download a list of ticker available below:
...
Next, **Select DBFS as Native integrations**:
...
### API call with python to fetch data
...
ticker_list = ticker_list.toPandas().values.tolist()
...
```python title="Wide to long transformation"
