...
![image](../../../assets/images/GitHub/github_new_repo.png){ width="600" }
no
In the configuration page, you can reproduce the same configuration as pictured below:

![image](../../../assets/images/GitHub/github_new_repo_config.png){ width="600" }
...
![image](../../../assets/images/GitHub/github_repo_url.png){ width="300" }
...
![image](../../../assets/images/Databricks/dbck_signup.png){ width="600" }

[:octicons-number-24: | Databricks Sign Up](https://www.databricks.com/learn/free-edition){ :target="_blank" .md-button .md-button--primary}
...
![image](../../../assets/images/Databricks/sbck_account__settings.png){ width="300" }

Select *Linked account* > *Add Git credentials* > *Link Git accounts*

![image](../../../assets/images/Databricks/dbck_link_github.png)
...
![image](../../../assets/images/Databricks/dbck_create_git_folder.png){ width="300" }

### Create your first Notebook

![image](../../../assets/images/Databricks/dbck_create_notebook.png){ width="300" }
...
Create scope: secret_keys
In Manage Principal select all workspace users to specify which users have the MANAGE permission on the secret scope.

![image](../../../assets/images/Databricks/create_secret_scope.png){ width="600" }
...
Copy your API Key from Alpha Vantage to store it in Databricks. It will avoid having your secret available on GitHub.
To create an alphavantage secret, use the following Python code:

```python title="Create a secret with Databricks"
